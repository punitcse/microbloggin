...
describe User do
  ...
  describe "Microblog associations" do
    ...
    it "should have the right Microblogs in the right order" do
      expect(@user.Microblogs.to_a).to eq [newer_Microblog, older_Microblog]
    end

    it "should destroy associated Microblogs" do
      Microblogs = @user.Microblogs.to_a
      @user.destroy
      expect(Microblogs).not_to be_empty
      Microblogs.each do |Microblog|
        expect(Microblog.where(id: Microblog.id)).to be_empty
      end
    end
